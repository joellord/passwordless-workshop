...
const AUTH_URL_PHP = "http://localhost:3000";
...
auth.loginTraditional = () => {
  ...
  // return fetch(AUTH_URL_PHP + "/magiclink", {method: "POST", body: formBody, headers: {'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'}})
  //Node
